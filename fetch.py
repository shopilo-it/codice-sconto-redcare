#!/usr/bin/env python3
"""
Recupero codici sconto Redcare da shopilo.it
Sursa: https://shopilo.it/negozi/redcare.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/redcare.it"
STORE_NAME = "Redcare"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Redcare da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-redcare)"
    }
    try:
